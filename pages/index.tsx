      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          <h3 className={"flex-box title"}>
            <span className="facebook flex-box mr-2">
              <svg
          ...
          <h3 className={"flex-box title"}>
            <span className="instagram flex-box mr-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="4rem"
                height="4rem"
            ...
            <span>
              <a href="https://www.instagram.com/hydroiins/">Hydro Instagram</a>
            </span>
          </h3>
          <h3 className={"flex-box title"}>
            <span className="tiktok flex-box mr-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="4rem"
                height="4rem"
            ...
            <span>
              <a href="https://www.tiktok.com/@hydrott">Hydro Tiktok</a>
            </span>
          </h3>
          <h3 className={"flex-box title"}>
            <span className="tiktok flex-box mr-2">
            ...
            <span>
              <a href="https://github.com/hunghuynh449">Hydro Github</a>
            </span>
          </h3>
        </main>
      </div>
