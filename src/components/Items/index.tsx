...
const SwitchIcon = ({ url }: { url: string }) => {
    ...
    return (
      ...
      >
        ...
        <path
          ...
          fill="#A6C5FA"
        />
        <path d="M85.3333 64H42.6667V69.3333H85.3333V64Z" fill="white" />
        <path d="M85.3333 74.6667H42.6667V80H85.3333V74.6667Z" fill="white" />
        <path
          d="M42.6667 85.3333H85.3333V90.6667H42.6667V85.3333Z"
          fill="white"
        />
        <path d="M74.6667 96H42.6667V101.333H74.6667V96Z" fill="white" />
        <defs>
          <linearGradient
  ...
  if (url.includes("docs.google.com/spreadsheets")) {
    return <Image src="/assets/execlIcon.png" alt="" width={40} height={55} />;
  }
      ...
      >
        <g clipPath="url(#clip0_62_697)">
          ...
          <path
            ...
            fill="#E94235"
          />
          <path d="M0 150.68H59.984V59.982H0.001L0 150.68Z" fill="#2684FC" />
          <path
  ...
  return <Image src="/assets/File-icon.png" alt="as" width={60} height={60} />;
};

const ItemCpn: React.FC<Props> = ({ item }) => {
  return (
    <>
      <h3 className="flex-box title">
        <span className="flex-box box-logo mr-2">
       {item?.img ?<img src={item.img} style={{width:"60px"}} /> : <SwitchIcon url={item.url} />}
        </span>
        <span>
